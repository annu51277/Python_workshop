...
#Buttons
def action():
    # print("Do something: Ansar Mohammad")
    value_entry = entry.get()
    label.config(text="Do something: Ansar Mohammad" , background='green',font=('Arial',10,'italic'))
    label.config(text=value_entry,background='pink',font=('Arial',9,'bold'))
    label.pack()
